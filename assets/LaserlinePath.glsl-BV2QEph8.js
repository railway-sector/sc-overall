import{IZ as be,IV as we,Jf as De,yz as f,yI as w,J2 as Ve,Hn as H,yA as r,dM as j,y0 as ee,IY as xe,yG as E,bq as te,bn as A,gL as B,Jg as ye,h8 as ie,yy as ne,HI as S,eT as _,bm as v,Jh as se,yK as ae,bo as o,mB as re,gK as Le,rw as Ee,br as Se,bD as le,fR as oe,gI as Ce,IW as Me,ye as Ae,HG as $e,Ih as Re,yJ as F,eV as Te,qA as ce,qC as he,_ as de,eW as Ie,eZ as G,qf as q,e as c,g as z,jI as pe,eX as ue,bk as Oe,bp as O,lP as Ue,HT as qe,lR as je,Ji as ze,yR as V,nX as Ne,nY as J,Jj as We,ne as He,Jk as $,Jl as Be,xc as k,rs as Fe,v4 as Ge,rt as Je,ru as ke,rv as Xe,rx as Ze,f as C,Jm as Ke,nF as X}from"./index-DJTPnSms.js";import{t as Ye}from"./VisualElement-BgsCLTOO.js";function fe(t,e){const n=t.fragment;n.include(be),t.include(we),n.include(De),n.uniforms.add(new f("globalAlpha",i=>i.globalAlpha),new w("glowColor",i=>i.glowColor),new f("glowWidth",(i,s)=>i.glowWidth*s.camera.pixelRatio),new f("glowFalloff",i=>i.glowFalloff),new w("innerColor",i=>i.innerColor),new f("innerWidth",(i,s)=>i.innerWidth*s.camera.pixelRatio),new Ve("depthMap",i=>i.depth?.attachment),new H("normalMap",i=>i.normals)),n.code.add(r`vec4 premultipliedColor(vec3 rgb, float alpha) {
