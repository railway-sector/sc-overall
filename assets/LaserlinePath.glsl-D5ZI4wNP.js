import{JH as Pe,JD as be,K6 as we,HB as f,IS as w,JJ as De,HC as W,Hy as r,fm as j,x8 as Y,JG as Ve,Iv as C,fL as ee,gG as T,he as F,K7 as xe,gc as te,IQ as ie,I8 as M,fw as m,fM as v,K8 as ne,zg as se,cv as o,mG as ae,hd as Ee,hy as ye,gF as Le,ck as re,gi as le,hb as Se,JE as Ce,xm as Me,I6 as Ae,I_ as $e,Hx as B,fy as Te,HE as oe,HF as ce,_ as he,p1 as Re,fK as G,hz as q,O as c,T as z,jZ as de,jX as pe,cp as Ie,cj as I,lR as Oe,Ih as qe,lW as Ue,K9 as je,HT as V,JN as ze,JO as K,Ka as Ne,nn as He,Kb as R,Kc as We,ht as Fe,uD as Be,hv as Ge,hw as Ke,hx as Je,hA as ke,Q as A,Kd as Qe,pA as J}from"./index-DgGqyiug.js";import{t as Xe}from"./VisualElement-DX78WW67.js";function ue(t,e){const n=t.fragment;n.include(Pe),t.include(be),n.include(we),n.uniforms.add(new f("globalAlpha",i=>i.globalAlpha),new w("glowColor",i=>i.glowColor),new f("glowWidth",(i,s)=>i.glowWidth*s.camera.pixelRatio),new f("glowFalloff",i=>i.glowFalloff),new w("innerColor",i=>i.innerColor),new f("innerWidth",(i,s)=>i.innerWidth*s.camera.pixelRatio),new De("depthMap",i=>i.depth?.attachment),new W("normalMap",i=>i.normals)),n.code.add(r`vec4 premultipliedColor(vec3 rgb, float alpha) {
...
return abs(dist);
}`),t.spherical){const i=(a,l,p)=>m(a,l.heightManifoldTarget,p.camera.viewMatrix),s=(a,l)=>m(a,[0,0,0],l.camera.viewMatrix);n.uniforms.add(new C("heightManifoldOrigin",(a,l)=>(i(u,a,l),s(D,l),ee(D,D,u),T(d,D),d[3]=F(D),d)),new xe("globalOrigin",a=>s(u,a)),new f("cosSphericalAngleThreshold",(a,l)=>1-Math.max(2,te(l.camera.eye,a.heightManifoldTarget)*l.camera.perRenderPixelRatio)/F(a.heightManifoldTarget))),n.code.add(r`float globeDistancePixels(float posInGlobalOriginLength) {
